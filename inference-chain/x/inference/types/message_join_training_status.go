...
func NewMsgJoinTrainingStatus(creator string, req *JoinTrainingRequest) *MsgJoinTrainingStatus {
	return &MsgJoinTrainingStatus{Creator: creator, Req: req}
}
...
func (msg *MsgJoinTrainingStatus) ValidateBasic() error {
	...
	// mirror JoinTraining checks: node_id non-empty, run_id > 0, outer_step >= 0
